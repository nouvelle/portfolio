					...
					<section>
						...
						<div className="box alt">
							<div className="row gtr-uniform">
								...
								<div className="col-4"><span className="image fit"><img src={port2} alt="" /></span></div>
								<div className="col-4"><span className="image fit"><img src={port3} alt="" /></span></div>
								<div className="col-4"><span className="image fit"><img src={port4} alt="" /></span></div>
								<div className="col-4"><span className="image fit"><img src={port4} alt="" /></span></div>
								<div className="col-4"><span className="image fit"><img src={port2} alt="" /></span></div>
								<div className="col-4"><span className="image fit"><img src={port3} alt="" /></span></div>
								<div className="col-4"><span className="image fit"><img src={port3} alt="" /></span></div>
